    ...
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      <main className="flex-grow pt-20 pb-12 flex flex-col items-center max-w-2xl mx-auto w-full px-4">
        <div className="w-full mb-6 text-center">
          ...
          <h2 className="font-serif text-2xl font-bold text-on-surface-variant">Digitize Your Kurta</h2>
        </div>
        ...
        <div className="relative w-full aspect-[3/4] bg-surface-container-high overflow-hidden shadow-2xl rounded-2xl">
          ...
          <div className="absolute top-4 left-1/2 -translate-x-1/2 bg-white/80 backdrop-blur-md px-4 py-2 flex items-center gap-2 rounded-full border border-outline-variant/10">
            ...
            <span className="font-sans text-[10px] tracking-widest uppercase font-bold text-on-surface">Scanning Fabric...</span>
          </div>
        ...
        <div className="w-full mt-8 flex flex-col items-center">
          <div className="w-full overflow-x-auto no-scrollbar flex gap-3 pb-6 px-2">
            {['Silk', 'Cotton', 'Linen', 'Wool', 'Khadi'].map((fabric, i) => (
              <button key={fabric} className={`shrink-0 font-sans text-[10px] tracking-widest uppercase px-6 py-2 rounded-full transition-all ${i === 0 ? 'bg-primary text-white shadow-lg' : 'bg-surface-container-highest text-on-surface-variant hover:bg-surface-container-high'}`}>
                {fabric}
              </button>
            ))}
          </div>
          ...
          <div className="flex items-center justify-between w-full px-8">
            <button className="flex flex-col items-center gap-1 text-secondary group">
            ...
            <button className="relative group">
              <div className="w-20 h-20 rounded-full border-[3px] border-primary flex items-center justify-center p-1.5 transition-transform active:scale-90">
                <div className="w-full h-full rounded-full bg-gradient-to-tr from-primary to-primary-container shadow-xl" />
              </div>
            </button>
            ...
            <button className="flex flex-col items-center gap-1 text-secondary group">
              ...
              <span className="font-sans text-[9px] tracking-widest uppercase font-semibold">Auto</span>
            </button>
          </div>
